...
{
    public partial class threeDimensional : Form
    {
        ...
        {
            threeDimdataGrid.Rows[0].Cells[0].Value = "2";//
            threeDimdataGrid.Rows[0].Cells[1].Value = "3";
            threeDimdataGrid.Rows[0].Cells[2].Value = "1";
